...
import { VideoQuickEditForm } from './video-quick-edit-form';
...
export function VideoTableRow({ row, selected, editHref, onSelectRow, onDeleteRow }) {
        ...
        <TableCell>
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            <Tooltip title="快速编辑" placement="top" arrow>
              <IconButton color={quickEditForm.value ? 'inherit' : 'default'}>
                <Iconify icon="solar:pen-bold" />
              </IconButton>
            </Tooltip>
