...
import { PicbookQuickEditForm } from './picbook-quick-edit-form';
...
export function PicbookTableRow({ row, selected, editHref, onSelectRow, onDeleteRow }) {
